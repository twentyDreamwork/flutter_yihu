...
import 'package:yihu/pages/category_page.dart';
import 'package:yihu/pages/new/detail.dart';
import 'package:yihu/provide/current_index_provide.dart';
    ...
    return InkWell(
      onTap: () {
        ...
        Navigator.push(
            ...
            new MaterialPageRoute(
                builder: (context) =>
                    new Detail(recommandList[index]['taobaoUrl'])));
      },
      child: Container(
        ...
        child: Column(
          children: <Widget>[
            ...
            Text(
              recommandList[index]['goodsContent'],
              maxLines: 2,
              overflow: TextOverflow.ellipsis,
              textAlign: TextAlign.left,
              style: TextStyle(fontSize: ScreenUtil().setSp(26)),
